...
var QuoteInquiryForm = React.createClass({
  ...
  handleAfterUnmount: function() {
    this.model.off();
    this.collection.off();
    Actions.resetBridgeQuoteInquiryForm();
  },
  ...
  handleAfterChange: function(refName, fieldValue) {
    ...
    Actions.updateBridgeQuoteInquiryFormAttributeData(refName, fieldValue);
  },
  ...
  handleValidations: function(refName, fieldValue) {
    Actions.validateBridgeQuoteInquiryFormField(refName, fieldValue);
  },
  ...
  handleSubmit: function(e) {
    ...
    Actions.setQuotingUrl(this.props.bridgeQuoteUrl);
    Actions.updateUrlWithParams(quoteQueryParams);
    Actions.fetchQuotes();
  },
